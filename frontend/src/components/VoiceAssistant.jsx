...
const COMMANDS = {
  weather: {
    en: ['weather', 'forecast', 'climate', 'rain', 'temperature', 'humidity', 'wind', 'is it going to rain'],
    hi: ['mausam', 'mosam', 'barish', 'dhoop', 'hawa', 'garmi', 'thanda', 'aaj ka mausam',
         'मौसम', 'बारिश', 'धूप', 'आज का मौसम', 'तापमान', 'बारिश होगी', 'हवा', 'नमी'],
    route: '/weather',
    responseEn: 'Opening weather forecast',
    responseHi: 'मौसम जानकारी खोल रहे हैं',
  },
  market: {
    en: ['market', 'mandi', 'price', 'rate', 'crop rate', 'crop price', 'commodity', 'bhav', 'how much', 'selling price'],
    hi: ['mandi', 'bhav', 'rate', 'dam', 'keemat', 'bazar', 'daam', 'kimat', 'kimat kitni hai',
         'मंडी', 'भाव', 'दाम', 'कीमत', 'बाजार', 'अनाज', 'रेट', 'कितने का है', 'बिक्री मूल्य'],
    route: '/market',
    responseEn: 'Checking market prices',
    responseHi: 'मंडी भाव देख रहे हैं',
  },
  crop: {
    en: ['crop', 'farming advice', 'fasal', 'agriculture', 'advisor', 'what to grow', 'best crop', 'sowing', 'harvesting'],
    hi: ['fasal', 'kheti', 'bona', 'kisan', 'kya ugaye', 'salah', 'paramarsh',
         'फसल', 'खेती', 'बोना', 'किसान', 'खेती-बाड़ी', 'फसलें', 'क्या उगाएं', 'सलाह', 'परामर्श'],
    route: '/crop',
    responseEn: 'Opening crop advisor',
    responseHi: 'फसल सलाह खोल रहे हैं',
  },
  fertilizer: {
    en: ['fertilizer', 'manure', 'khad', 'soil health', 'pesticide', 'medicine', 'urea', 'organic khad'],
    hi: ['khad', 'urvarak', 'khaad', 'dawai', 'dawae', 'keetnashak', 'mitti',
         'खाद', 'उर्वरक', 'दवाई', 'कीटनाशक', 'मिट्टी की जांच', 'मिट्टी', 'दवा'],
    route: '/fertilizer',
    responseEn: 'Opening fertilizer guide',
    responseHi: 'खाद की जानकारी खोल रहे हैं',
  },
  labour: {
    en: ['labour', 'worker', 'mazdoor', 'help', 'hiring', 'find labour', 'maid', 'helper'],
    hi: ['mazdoor', 'majdoor', 'kaamgaar', 'mazdur', 'kamgar', 'sahayata', 'madad chahiye',
         'मजदूर', 'मज़दूर', 'काम', 'कामगार', 'मदद', 'सहायता', 'मजदूर ढूंढो'],
    route: '/labour',
  ...
  schemes: {
    en: ['schemes', 'government', 'subsidy', 'yojana', 'help', 'benefits', 'sarkari help', 'pm kisan'],
    hi: ['yojana', 'yojanaye', 'sarkari', 'madad', 'labh', 'fayda', 'sarkari yojana',
         'योजना', 'योजनाएं', 'सरकारी', 'मदद', 'सब्सिडी', 'लाभ', 'फायदा', 'सरकारी योजना'],
    route: '/schemes',
