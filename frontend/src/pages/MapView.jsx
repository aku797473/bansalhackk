      ...
      <div className="page-header flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-8">
        <div>
          <h1 className="page-title flex items-center gap-3">
            ...
            <span>Live Field Mapping</span>
          </h1>
          <p className="page-subtitle text-gray-500 font-medium mt-1">Track your movement & measure field area using GPS.</p>
        </div>
        
        <div className="flex bg-white dark:bg-slate-900 rounded-2xl p-1 shadow-sm border border-gray-100 dark:border-slate-800">
          <button onClick={() => setTileMode('street')} className={clsx('px-4 py-2 rounded-xl text-xs font-bold transition-colors uppercase tracking-widest', tileMode === 'street' ? 'bg-primary text-white' : 'text-gray-500 hover:bg-gray-50 dark:hover:bg-slate-800')}>Street</button>
          <button onClick={() => setTileMode('satellite')} className={clsx('px-4 py-2 rounded-xl text-xs font-bold transition-colors uppercase tracking-widest', tileMode === 'satellite' ? 'bg-primary text-white' : 'text-gray-500 hover:bg-gray-50 dark:hover:bg-slate-800')}>Satellite</button>
        </div>
      </div>
      ...
      <div className="flex flex-col xl:flex-row gap-6">
        ...
        <div className="xl:w-80 shrink-0 flex flex-col gap-6">
          ...
          <div className="card bg-white dark:bg-slate-900 border-none shadow-xl p-6 flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <h2 className="text-sm font-black uppercase tracking-widest text-gray-800 dark:text-white flex items-center gap-2">
                <Navigation size={16} className="text-blue-500" /> GPS Tracking
              </h2>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/10 p-4 rounded-2xl border border-blue-100 dark:border-blue-900/20 text-center">
                ...
                <p className="text-[10px] font-bold text-blue-800/60 dark:text-blue-200/60 uppercase tracking-widest">Meters</p>
              </div>
            </div>
          ...
          <div className="card bg-white dark:bg-slate-900 border-none shadow-xl p-6 flex flex-col gap-4 flex-1">
            <h2 className="text-sm font-black uppercase tracking-widest text-gray-800 dark:text-white flex items-center gap-2">
              <Ruler size={16} className="text-green-500" /> Area Measurement
            </h2>
            ...
            <div className="bg-green-50 dark:bg-green-900/10 p-4 rounded-2xl border border-green-100 dark:border-green-900/20">
              ...
              <p className="text-xs font-bold text-green-800/60 dark:text-green-200/60 uppercase tracking-widest">Total Acres</p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-slate-800/50 p-4 rounded-2xl border border-gray-100 dark:border-slate-800 flex justify-between items-center">
              <div>
                ...
                <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Hectares</p>
              </div>
              <div className="text-right">
                <p className="text-lg font-black text-gray-700 dark:text-slate-200">{Math.round(area.sqm).toLocaleString()}</p>
                <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Sq. Meters</p>
              </div>
            </div>

            <div className="mt-auto">
              <p className="text-[10px] text-gray-400 font-medium mb-3 text-center">Points added: {fieldPoints.length}</p>
