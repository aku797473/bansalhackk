        ...
        <div className="max-w-7xl mx-auto h-16 sm:h-20 border border-slate-100 dark:border-white/5 bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl rounded-2xl sm:rounded-[1.5rem] px-4 sm:px-8 flex items-center justify-between shadow-2xl">
          ...
          <div className="flex items-center gap-4 sm:gap-8">
             ...
             <button 
               ...
               className="px-4 sm:px-8 py-2 sm:py-3 bg-slate-900 dark:bg-white text-white dark:text-black text-[9px] sm:text-[11px] font-black uppercase tracking-widest rounded-lg sm:rounded-xl hover:scale-105 transition-all shadow-xl"
             >
               {t('landing.login')}
             </button>
          </div>
