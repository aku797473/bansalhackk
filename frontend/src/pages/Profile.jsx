  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = async () => {
        toast.loading('Optimizing profile picture...', { id: 'pic_loading' });
        try {
          const compressed = await compressImage(reader.result);
          await updateUser({ image: compressed, profilePic: compressed });
          toast.success('Profile picture updated successfully', { id: 'pic_loading' });
        } catch (err) {
          toast.error('Failed to update profile picture', { id: 'pic_loading' });
        }
      };
